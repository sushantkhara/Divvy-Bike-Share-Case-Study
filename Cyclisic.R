...
# This analysis is for Cyclistics Bike-Share case study 
...
# check last 6 rows added in the merged data frame
tail(all_trips)
...
# Remove duplicate fields an
all_trips %>%
  distinct()

# Remove missing and empty fields
